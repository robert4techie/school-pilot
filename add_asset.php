...
$tracker->trackAction("Add Assets");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $asset_code_prefix = strtoupper(substr($asset_name, 0, 3));
    $random_number = str_pad(mt_rand(1, 9999), 4, '0', STR_PAD_LEFT);
    $asset_code = $asset_code_prefix . '-' . $random_number;
    ...
    if (isset($_FILES['asset_image']) && $_FILES['asset_image']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($_FILES['asset_image']['tmp_name'], $file_path)) {
            ...
            setSessionToast('Error uploading image.', 'error');
    ...
    $sql = "INSERT INTO assets (
                asset_name, asset_code, category, quantity, unit, status, serial_number, model,
                min_stock_level, description, unit_price, total_cost, purchase_date, warranty_period,
                warranty_expiry, depreciation_rate, supplier_name, supplier_contact, supplier_email,
                supplier_address, invoice_number, payment_method, storage_location, assigned_to,
                department, asset_condition, asset_image, maintenance_schedule, next_maintenance,
                insurance_value, disposal_date, barcode
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    $stmt->bind_param(
        "sssisssisddsisdssssssssssssssdss",
        $asset_name,
        $asset_code,
        $category,
        $quantity,
    ...
    if ($stmt->execute()) {
        setSessionToast('Asset added successfully!', 'success');
        header('Location: add_asset.php');
    } else {
        setSessionToast('Error adding asset: ' . $stmt->error, 'error');
        header('Location: add_asset.php');
    }
...
<head>
    ...
    <title>Add New Asset - School Pilot</title>
...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <p>Register and manage school assets efficiently</p>
        </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="asset_code" name="asset_code" readonly placeholder="Auto-generated">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="quantity" name="quantity" required min="1" step="1" placeholder="Enter quantity">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="serial_number" name="serial_number" placeholder="Manufacturer serial number">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="model" name="model" placeholder="Brand and model">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="min_stock_level" name="min_stock_level" min="0" step="1" placeholder="Minimum quantity threshold">
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea id="description" name="description" rows="3" placeholder="Additional notes about the asset..."></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="number" id="unit_price" name="unit_price" step="1" required min="0" placeholder="Enter unit price in UGX">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="total_cost" name="total_cost" step="1" required min="0" placeholder="Total purchase cost" readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="warranty_period" name="warranty_period" min="0" placeholder="Warranty in months">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="warranty_expiry" name="warranty_expiry" readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="depreciation_rate" name="depreciation_rate" min="0" max="100" step="0.1" placeholder="Annual depreciation rate">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" id="supplier_name" name="supplier_name" placeholder="Company/Supplier name">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" id="supplier_contact" name="supplier_contact" placeholder="Phone number">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="supplier_email" name="supplier_email" placeholder="Email address">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="supplier_address" name="supplier_address" placeholder="Physical address">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="invoice_number" name="invoice_number" placeholder="Purchase invoice number">
                        </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <select id="storage_location" name="storage_location" required>
                                ...
                                <option value="classroom_1">Classroom 1</option>
                                <option value="classroom_2">Classroom 2</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="assigned_to" name="assigned_to" placeholder="Staff name or department">
                        </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="insurance_value" name="insurance_value" min="0" step="1" placeholder="Insurance coverage value">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="barcode" name="barcode" placeholder="Barcode or QR code">
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        // Auto-generate Asset Code on Asset Name input
        document.getElementById('asset_name').addEventListener('input', function() {
            const assetName = this.value.trim().toUpperCase();
            const prefix = assetName.substring(0, 3);
            const randomNumber = Math.floor(1000 + Math.random() * 9000); // 4-digit number
            document.getElementById('asset_code').value = `${prefix}-${randomNumber}`;
        });
