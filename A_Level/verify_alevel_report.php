...
$exam_sets_param = isset($_GET['exam_sets']) ? sanitize_input($_GET['exam_sets']) : '';
...
// Check for marks in A-Level table
...
if ($table_exists) {
    // For A-Level, we need to check for exam sets
    ...
    if ($exam_stmt) {
        ...
        $marks_count = mysqli_num_rows($exam_result);
...
display_verification_page($student, $term, $year, $class, $stream, $has_marks, $marks_count, $school_info, $exam_sets_param);

mysqli_close($conn);

// ==================== DISPLAY FUNCTIONS ====================

function display_verification_page($student, $term, $year, $class, $stream, $has_marks, $marks_count, $school_info, $exam_sets_param)
{
    ...
    $photo = !empty($student['profile_photo']) ? htmlspecialchars($student['profile_photo']) : '../images/avartor.png';

    $school_name = isset($school_info['school_name']) ? htmlspecialchars($school_info['school_name']) : 'School Name';
    $school_logo_path = isset($school_info['logo_path']) ? htmlspecialchars($school_info['logo_path']) : '../assets/img/logo.jpg';

    // Clean up logo path
    $school_logo = str_replace('uploads/school_logos/', '../uploads/school_logos/', $school_logo_path);

    $verification_date = date('l, F j, Y \a\t g:i A');
    $verification_id = 'VRF-AL-' . strtoupper(substr(md5($student_id . time()), 0, 10));
...
?>
    ...
    <head>
        ...
        <title>A-Level Report Verification - <?php echo $student_name; ?></title>
        ...
        <style>
            ...
            * {
            ...
            .btn-primary:hover {
                transform: translateY(-2px);
                box-shadow: var(--shadow-md);
                background: linear-gradient(135deg, var(--primary-dark) 0%, #0a2e5c 100%);
            }
            ...
            <div class="header">
                <div class="header-content">
                    ...
                    <div class="verification-badge">
                        ...
                        <span>A-Level Report Verification</span>
                    </div>
                </div>
            </div>
            ...
            <div class="content">
                <?php if ($has_marks): ?>
                    <div class="status-banner success">
                        ...
                        <div class="status-content">
                            <h3>Authentic A-Level Report Card Verified</h3>
                            <p>This A-Level report card has been successfully verified against official school records and is confirmed to be authentic.</p>
                        </div>
                    </div>
                <?php else: ?>
                    <div class="status-banner warning">
                        ...
                        <div class="status-content">
                            ...
                            <p>The student record exists in our system, but no A-Level marks have been recorded for this academic term.</p>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="student-card">
                    <div class="student-header">
                        <div class="student-photo-container">
                            <img src="<?php echo $photo; ?>" alt="Student Photo" class="student-photo" onerror="this.src='../images/avartor.png'">
                ...
                <div class="report-details">
                    ...
                    <?php if ($has_marks): ?>
                        <div class="detail-row">
                            ...
                            <div class="detail-value"><?php echo $marks_count; ?> exam set(s) found</div>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <?php if ($has_marks): ?>
                    <div class="action-buttons">
                        <a href="reports.php?verified=1&verification_token=<?php echo $verification_token; ?>&student_id=<?php echo urlencode($student_id); ?>&class=<?php echo urlencode($class); ?>&stream=<?php echo urlencode($stream); ?>&term=<?php echo urlencode($term); ?>&year=<?php echo urlencode($year); ?>&exam_sets=<?php echo urlencode($exam_sets_param); ?>"
    ...
    <body>
        <div class="error-container">
            <div class="error-header">
                ...
                <p>A-Level report card could not be verified</p>
            </div>
            <div class="error-content">
                <p>We were unable to verify the authenticity of this A-Level report card.</p>
                <div class="error-box">
                    ...
                    <ul>
                        ...
                        <li><i class="fas fa-circle"></i> Student is not enrolled in A-Level program</li>
                    </ul>
                </div>
                <div class="help-text">
                    <strong>Verification Details:</strong><br>
                    Student ID: <?php echo htmlspecialchars($student_id); ?><br>
                    Term: <?php echo htmlspecialchars($term); ?> <?php echo htmlspecialchars($year); ?><br>
                    Level: A-Level
                </div>
            </div>
        </div>
