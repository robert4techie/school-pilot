...
if (!mysqli_stmt_execute($stmt)) {
    echo json_encode(['success' => false, 'error' => 'Failed to delete gate pass: ' . mysqli_stmt_error($stmt)]);
...
if ($affected > 0) {
    echo json_encode(['success' => true, 'message' => 'Gate pass deleted successfully.']);
} else {
    echo json_encode(['success' => false, 'error' => 'Gate pass not found or already deleted.']);
}
