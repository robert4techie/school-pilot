...
function display_verification_page($student, $term, $year, $class, $stream, $has_marks, $marks_count, $school_info)
{
    ...
    // Fixed: Correct default avatar path
    ...
    // Fixed: Correct logo path handling
    $school_logo = isset($school_info['logo_path']) ? '/' . ltrim(htmlspecialchars($school_info['logo_path']), '/') : '../assets/img/logo.jpg';

    $verification_date = date('l, F j, Y \a\t g:i A');
    $verification_id = 'ASM-VRF-' . strtoupper(substr(md5($student_id . time()), 0, 10));
...
?>
    ...
    <head>
        ...
        <title>Assessment Report Verification - <?php echo $student_name; ?></title>
        ...
        <style>
            ...
            * {
            ...
            .btn-primary:hover {
                transform: translateY(-2px);
                box-shadow: var(--shadow-md);
                background: linear-gradient(135deg, var(--primary-dark) 0%, #082b0a 100%);
            }
            ...
            @media print {
                ...
                .footer::after {
                    content: 'OFFICIAL ASSESSMENT REPORT VERIFICATION';
                    position: fixed;
                    bottom: 20px;
                    left: 50%;
            ...
            <div class="header">
                <div class="header-content">
                    ...
                    <div class="verification-badge">
                        ...
                        <span>Assessment Report Verification</span>
                    </div>
                </div>
            </div>
            ...
            <div class="content">
                <?php if ($has_marks): ?>
                    <div class="status-banner success">
                        ...
                        <div class="status-content">
                            <h3>Authentic Assessment Report Verified</h3>
                            <p>This assessment report card has been successfully verified against official school records and is confirmed to be authentic.</p>
                        </div>
                    </div>
                <?php else: ?>
                    <div class="status-banner warning">
                        ...
                        <div class="status-content">
                            <h3>Student Record Found - No Assessment Data Available</h3>
                            <p>The student record exists in our system, but no assessment marks have been recorded for this academic term.</p>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="report-details">
                    <div class="report-type-badge">
                        ...
                        <span>Assessment Report Card</span>
                    </div>
                    ...
                    <?php if ($has_marks): ?>
                        <div class="detail-row">
                            ...
                            <div class="detail-value"><?php echo $marks_count; ?> records found</div>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <?php if ($has_marks): ?>
                    <!--<div class="action-buttons">
                        <a href="assessment_report.php?student_id=<?php echo urlencode($student_id); ?>&class=<?php echo urlencode($class); ?>&stream=<?php echo urlencode($stream); ?>&term=<?php echo urlencode($term); ?>&year=<?php echo urlencode($year); ?>&verified=1&verification_token=<?php echo $verification_token; ?>"
    ...
    <body>
        <div class="error-container">
            <div class="error-header">
                ...
                <p>Assessment report could not be verified</p>
            </div>
            <div class="error-content">
                <p>We were unable to verify the authenticity of this assessment report card.</p>
                <div class="error-box">
                    ...
                    <ul>
                        ...
                        <li><i class="fas fa-circle"></i> Assessment report information may have been tampered with</li>
                ...
                <div class="help-text">
                    ...
                    Report Type: <span style="color: #1b5e20; font-weight: 600;">Assessment Report</span>
                </div>
            </div>
        </div>
    </body>
