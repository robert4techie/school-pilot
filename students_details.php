...
$tracker->trackAction("Students details");
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Students Details - schoolPilot</title>
...
<body>
    ...
    <div class="container">
        <div class="header">
            <h2><i class="fas fa-graduation-cap"></i> School pilot</h2>
            <p>Manage and download student records with ease</p>
        </div>
        ...
        <div class="controls">
            <div class="controls-row">
                ...
                <button class="btnn btnn-primary" onclick="loadStudents()">
    ...
    <div id="viewStudentModal" class="modal">
        <div class="modal-content" style="max-width: 800px;">
            ...
            <div class="modal-footer">
                <button class="btnn btnn-primary" onclick="downloadStudentPDF(currentViewingStudentId)">
    ...
    <script>
        ...
        function setupEventListeners() {
            ...
            document.getElementById('streamFilter').addEventListener('change', filterStudents);
        ...
        async function loadStudents() {
            try {
                ...
                if (data.success) {
                    ...
                    showToast('Error loading students: ' + data.message, 'error');
                }
            } catch (error) {
        ...
        function displayStudents(studentsToShow) {
            ...
            container.innerHTML = `
                <div class="students-grid">
                    ${studentsToShow.map(student => createStudentCard(student)).join('')}
                </div>
            `;
        }
                ...
                <div class="student-card" data-student-id="${student.id}">
                    <div class="card-header">
                        ...
                        <input type="checkbox" class="select-checkbox student-checkbox" 
                               data-student-id="${student.id}" onchange="toggleStudentSelection(this)">
                    </div>
                    ...
                    <div class="student-details">
                        <div class="detail-item">
                            ...
                            <span class="detail-value">${formatDate(student.date_of_birth)}</span>
                        </div>
                        <div class="detail-item">
                        ...
                        <div class="detail-item">
                            ...
                            <span class="detail-value">${student.current_class}</span>
                        </div>
                        <div class="detail-item">
                        ...
                        <div class="detail-item">
                            ...
                            <span class="detail-value">${formatDate(student.date_of_enrolment)}</span>
                        </div>
                    </div>
                    
                    <div class="card-actions">
                        <button class="btnn btnn-info" onclick="viewStudent(${student.id})">
                            <i class="fas fa-eye"></i> View
                        </button>
                        <button class="btnn btnn-danger" onclick="downloadStudentPDF(${student.id})">
        ...
        async function downloadStudentPDF(studentId) {
            ...
            try {
                ...
                generatePDFContent(doc, student);
                doc.save(`${student.first_name}_${student.last_name}_${student.student_id}.pdf`);
        ...
        async function downloadSelectedPDFs() {
            ...
            try {
                ...
                showToast(`${selectedStudents.length} PDFs downloaded successfully!`, 'success');
                closeModal();
            } catch (error) {
        ...
        function generatePDFContent(doc, student) {
            // Header
            doc.setFontSize(20);
            doc.setTextColor(45, 90, 61);
            doc.text('STUDENT INFORMATION RECORD', 105, 20, {
                align: 'center'
            });
            ...
            doc.setFontSize(16);
            doc.setTextColor(45, 90, 61);
            doc.text(`${student.first_name} ${student.last_name}`, 70, 45);

            doc.setFontSize(12);
            doc.setTextColor(100, 100, 100);
            doc.text(`Student ID: ${student.student_id}`, 70, 55);
            ...
            const personalInfo = [
                ...
                ['Gender:', capitalizeFirst(student.gender)],
                ['Nationality:', student.nationality],
                ['Religion:', student.religion || 'Not specified'],
                ['Residential Address:', student.residential_address]
            ];
            ...
            const academicInfo = [
                ...
                ['Date of Enrolment:', formatDate(student.date_of_enrolment)],
                ['Previous School:', student.previous_school || 'Not specified'],
                ['Subject Combination:', student.subject_combination],
                ['School Pay Code:', student.school_pay_code]
            ];
        ...
        <div class="student-detail-view">
            <div class="detail-header">
                ...
                <div class="student-main-info">
                    ...
                    <p class="student-class">${student.current_class} ${student.stream}</p>
                </div>
            </div>
            ...
            <div class="detail-sections">
                <div class="detail-section">
                    ...
                    <div class="detail-grid">
                        ...
                        <div class="detail-item">
                            ...
                            <span class="detail-value">${student.religion || 'Not specified'}</span>
                        </div>
                        <div class="detail-item full-width">
                            <span class="detail-label">Address:</span>
                            <span class="detail-value">${student.residential_address}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="detail-section">
                    ...
                    <div class="detail-grid">
                        <div class="detail-item">
                            <span class="detail-label">Enrolment Date:</span>
                            <span class="detail-value">${formatDate(student.date_of_enrolment)}</span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Previous School:</span>
                            <span class="detail-value">${student.previous_school || 'Not specified'}</span>
                        </div>
                        <div class="detail-item full-width">
                            <span class="detail-label">Subject Combination:</span>
                            <span class="detail-value">${student.subject_combination}</span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">School Pay Code:</span>
                            <span class="detail-value">${student.school_pay_code}</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    `;
        ...
        function exportToExcel() {
            // Create CSV content
            const headers = ['Student ID', 'First Name', 'Last Name', 'Date of Birth', 'Gender', 'Nationality', 'Religion', 'Class', 'Stream', 'Enrolment Date'];
            const csvContent = [
                headers.join(','),
